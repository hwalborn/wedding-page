        ...
        <div id="about-the-couple">
          {
            ...
            <Container id="about-couple-container">
              ...
              <Row className="about-container">
                ...
                <Col className="about-container" data-aos="fade-left" md={this.state.aboutContainerWidth} data-aos-anchor-placement="top-bottom">
                  <img className="about-image"  src={saraImage} />
                </Col>
              </Row>
              <Row id="bottom-row" className="about-container">
                <Col className="about-container" data-aos="fade-right" md={this.state.aboutContainerWidth} data-aos-anchor-placement="top-bottom">
